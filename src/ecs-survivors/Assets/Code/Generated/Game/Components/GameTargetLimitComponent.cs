...
public partial class GameEntity {
    ...
    public Code.Gameplay.Features.Armaments.ArmamentComponents.TargetLimit targetLimit { get { return (Code.Gameplay.Features.Armaments.ArmamentComponents.TargetLimit)GetComponent(GameComponentsLookup.TargetLimit); } }
    ...
    public GameEntity AddTargetLimit(int newValue) {
        ...
        var component = (Code.Gameplay.Features.Armaments.ArmamentComponents.TargetLimit)CreateComponent(index, typeof(Code.Gameplay.Features.Armaments.ArmamentComponents.TargetLimit));
