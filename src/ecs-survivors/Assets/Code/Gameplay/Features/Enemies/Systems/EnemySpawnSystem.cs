...
namespace Code.Gameplay.Features.Enemies.Systems
{
    public class EnemySpawnSystem : IExecuteSystem
    {
        ...
        public EnemySpawnSystem(GameContext gameContext, ITimeService timeService, IEnemyFactory enemyFactory, ICameraProvider cameraProvider)
        {
        ...
        private Vector2 RandomSpawnPosition(Vector2 heroWorldPosition)
        {
            ...
            return startWithHorizontal ? HorizontalSpawnPosition(heroWorldPosition) : VerticalSpawnPosition(heroWorldPosition);
        }
