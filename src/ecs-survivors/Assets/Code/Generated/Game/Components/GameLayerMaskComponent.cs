...
public partial class GameEntity {
    ...
    public Code.Gameplay.Features.TargetCollection.TargetCollectionComponents.LayerMask layerMask { get { return (Code.Gameplay.Features.TargetCollection.TargetCollectionComponents.LayerMask)GetComponent(GameComponentsLookup.LayerMask); } }
    ...
    public GameEntity AddLayerMask(int newValue) {
        ...
        var component = (Code.Gameplay.Features.TargetCollection.TargetCollectionComponents.LayerMask)CreateComponent(index, typeof(Code.Gameplay.Features.TargetCollection.TargetCollectionComponents.LayerMask));
