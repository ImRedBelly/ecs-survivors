...
public partial class GameEntity {
    ...
    public Code.Gameplay.Features.TargetCollection.TargetCollectionComponents.Radius radius { get { return (Code.Gameplay.Features.TargetCollection.TargetCollectionComponents.Radius)GetComponent(GameComponentsLookup.Radius); } }
    ...
    public GameEntity AddRadius(float newValue) {
        ...
        var component = (Code.Gameplay.Features.TargetCollection.TargetCollectionComponents.Radius)CreateComponent(index, typeof(Code.Gameplay.Features.TargetCollection.TargetCollectionComponents.Radius));
