...
namespace Code.Gameplay.Features.Enchants.Systems
{
    public class ExplosiveEnchantSystem : ReactiveSystem<GameEntity>
    {
        ...
        {
            return context.CreateCollector(GameMatcher.AllOf(GameMatcher.Armament, GameMatcher.Reached).Added());
        }
        ...
        protected override void Execute(List<GameEntity> armaments)
        {
            ...
            {
                _armamentFactory.CreateExplosive(enchant.ProducerId, armament.WorldPosition);
            }
        }
    }
}