...
{
    public sealed class BindEntityViewFromPathSystem : IExecuteSystem
    {
        ...
        public BindEntityViewFromPathSystem(GameContext gameContext, IEntityViewFactory entityViewFactory)
        {
            ...
            _entities = gameContext.GetGroup(GameMatcher.AllOf(GameMatcher.ViewPath).NoneOf(GameMatcher.View));
        }
